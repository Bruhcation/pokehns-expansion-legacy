...
const u32 gTrainerFrontPic_OakHns[] = INCBIN_U32("graphics/trainers/front_pics/oak_hns.4bpp.smol");
const u16 gTrainerPalette_OakHns[] = INCBIN_U16("graphics/trainers/front_pics/oak_hns.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_OAK_HNS, gTrainerFrontPic_OakHns, gTrainerPalette_OakHns),
};
