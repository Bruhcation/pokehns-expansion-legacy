...
#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 110 : 85)
...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .abilities = { ABILITY_TANGLED_FEET, ABILITY_KEEN_EYE, ABILITY_BIG_PECKS },
    #else
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GALE_WINGS, ABILITY_KEEN_EYE, ABILITY_BIG_PECKS },
    #else
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_RUN_AWAY, ABILITY_HUSTLE },
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_KEEN_EYE, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_BROWN,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_CUTE_CHARM, ABILITY_FRIEND_GUARD },
    #else
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_CUTE_CHARM, ABILITY_UNAWARE },
    #else
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 100,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 86 : 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 75,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .baseSpeed     = 100,
        .baseSpAttack  = 90,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 95 : 90,
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 75,
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ARENA_TRAP, ABILITY_SAND_VEIL, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
...
#if P_FAMILY_MEOWTH
#if P_UPDATED_ABILITIES >= GEN_4
    #define MEOWTH_ABILITIES { ABILITY_TECHNICIAN, ABILITY_HUSTLE, ABILITY_PICKUP }
#else
    #define MEOWTH_ABILITIES { ABILITY_PICKUP, ABILITY_HUSTLE, ABILITY_HUSTLE }
#endif
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TECHNICIAN, ABILITY_HUSTLE, ABILITY_LIMBER },
    #else
        .abilities = { ABILITY_LIMBER, ABILITY_HUSTLE, ABILITY_LIMBER },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MEOWTH_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_TECHNICIAN, ABILITY_HUSTLE },
    ...
    [SPECIES_PERSIAN_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_TECHNICIAN, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_GRAY,
#if P_SEPARATE_REGIONAL_FORMS
    ...
    [SPECIES_PONYTA_GALAR] =
    {
        ...
        .formSpeciesIdTable = sPonytaFormSpeciesIdTable,
#endif
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_RAPIDASH_GALAR}),
    },
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .abilities = { ABILITY_DEFIANT, ABILITY_INNER_FOCUS, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .baseSpeed     = 25,
        .baseSpAttack  = 40,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 75 : 40,
        .types = MON_TYPES(TYPE_POISON),
        .catchRate = 190,
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sGrimerFormSpeciesIdTable,
#endif
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_MUK_ALOLA}),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_CURSED_BODY, ABILITY_NONE}
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SCRAPPY, ABILITY_EARLY_BIRD, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_ILLUMINATE, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_TOUGH_CLAWS, ABILITY_MOXIE },
    #else
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .baseSpeed     = 55,
        .baseSpAttack  = 115,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 90 : 115,
        .types = MON_TYPES(TYPE_ROCK, TYPE_WATER),
        .catchRate = 45,
